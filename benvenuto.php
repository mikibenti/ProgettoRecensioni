        ...
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                <ul class="user-info list-unstyled mb-4">
                    <li><strong><i class="fas fa-user me-2"></i>Nome:</strong> <?php echo $nome ?></li>           
                    <li><strong><i class="fas fa-user me-2"></i>Cognome:</strong> <?php echo $cognome ?></li>       
                    <li><strong><i class="fas fa-envelope me-2"></i>Email:</strong> <?php echo $email ?></li>
